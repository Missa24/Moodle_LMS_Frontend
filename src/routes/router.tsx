...
export const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            },
            {
                path: "cursos",
                children: [
                    { index: true, element: lazyElement(CursoCatalogoPage) },
                    {
                        path: ":cursoId",
                        children: [
                            { index: true, element: lazyElement(CursoModulosPage) },
                            { path: "modulos/:moduloId", element: lazyElement(ModuloDetallePublicPage) },
                        ],
                    },
                ],
            },
...

            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        children: [
                            { index: true, element: lazyElement(InicioPage) },
                            { path: "perfil", element: lazyElement(ProfilePage) },

                            {
                                path: "usuario",
                                children: [
                                    { index: true, element: lazyElement(UsuarioPage) },
                                    { path: ":id", element: lazyElement(UsuarioDetallePage) },
                                ],
                            },

                            {
                                path: "cursos",
                                children: [
                                    { index: true, element: lazyElement(CursosPage) },
                                    { path: "mis-cursos", element: lazyElement(MisCursosPage) },
                                    {
                                        path: ":id",
                                        children: [
                                            { index: true, element: lazyElement(CursoDetallePage) },
                                            {
                                                path: "modulos",
                                                children: [
                                                    { index: true, element: lazyElement(ModulosPage) },
                                                    {
                                                        path: ":moduloId",
                                                        children: [
                                                            { index: true, element: lazyElement(ModuloDetallePage) },
                                                            {
...

                            {
                                path: "inscripciones",
                                children: [
                                    { index: true, element: lazyElement(InscripcionesPage) },
                                    { path: "crear", element: lazyElement(CrearInscripcionPage) },
                                    { path: "estudiante/:estudianteId", element: lazyElement(EditarInscripcionPage) },
                                ],
                            },
                            { path: "certificados", element: lazyElement(MisCertificados) },
                        ],
                    },
                ],
            },
